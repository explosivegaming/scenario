...
local function draw_edit_mode(player,frame)
	...
	frame.add{type='flow',name='buuton_flow',direction='horizontal'}
	ExpGui.add_input.draw_button(frame.buuton_flow,'save')
	ExpGui.add_input.draw_button(frame.buuton_flow,'exit')
	ExpGui.add_input.draw_button(frame.buuton_flow,'add_task')
end
