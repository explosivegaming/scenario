...
local task_list_item =
    Gui.element(
    function(definition, parent, element_define)
        ...
        local top_element = top_flow.children[element_define.name]
...
local task_list_container =
    ...
    function(definition, parent)
        ...
        local toggle_element = toggle(header)
