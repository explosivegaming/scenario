...
Selection.on_selection(SelectionModuleArea, function(event)
    ...
    for i=1, config.module_row do
        mma = frame.container.scroll.table['module_mm_' .. i .. '_0'].elem_value
        ...
        if mma ~= nil then
            ...
            for j=1, config.module_slot_max do
                mmo = frame.container.scroll.table['module_mm_' .. i .. '_' .. j].elem_value
    ...
    for _, entity in pairs(entities) do
        mcm = entity.get_module_inventory()
