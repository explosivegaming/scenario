...
Commands.new_command('give-warning', {'expcom-warnings.description-give'})
...
Commands.new_command('get-warnings', {'expcom-warnings.description-get'})
...
Commands.new_command('clear-warnings', {'expcom-warnings.description-clear'})
