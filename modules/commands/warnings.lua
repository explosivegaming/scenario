...
Commands.new_command('give-warning', {'expcom-warnings.descr-give'})
...
Commands.new_command('get-warnings', {'expcom-warnings.descr-get'})
...
Commands.new_command('clear-warnings', {'expcom-warnings.descr-clear'})
